...
func TestSerialize(t *testing.T) {
	tests := []struct {
		...
		{"Null Bulk String",
			...
			"$-1\r\n"},
		{"Array with Ping",
			RESPMessage{Type: Array, Payload: []RESPMessage{{Type: BulkString, Payload: "ping"}}},
			"*1\r\n$4\r\nping\r\n"},
		{"Array with Echo",
			RESPMessage{Type: Array, Payload: []RESPMessage{{Type: BulkString, Payload: "echo"}, {Type: BulkString, Payload: "hello world"}}},
			"*2\r\n$4\r\necho\r\n$11\r\nhello world\r\n"},
		{"Array with Get Key",
			RESPMessage{Type: Array, Payload: []RESPMessage{{Type: BulkString, Payload: "get"}, {Type: BulkString, Payload: "key"}}},
			"*2\r\n$3\r\nget\r\n$3\r\nkey\r\n"},
		{"Simple String OK",
			RESPMessage{Type: SimpleString, Payload: "OK"},
			"+OK\r\n"},
		{"Error Message",
